"""
Django settings for django_ten project.
...
SECRET_KEY = '(*dr^r-xlbln)l7=s8fvzd%-2&08jenruq)!m$yyz$#abfz=3p'
...
MIDDLEWARE = [
    ...
    'ten.middlewares.TenantMiddleware',
]

ROOT_URLCONF = 'django_ten.urls'
...
WSGI_APPLICATION = 'django_ten.wsgi.application'
